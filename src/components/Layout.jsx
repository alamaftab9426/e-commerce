...
const Layout = ({children, update})=>{
    ...
    return (
                    ...
                    <ul className="md:flex gap-6 items-center hidden font-semibold">
                        {
                            menus.map((item, index)=>(
                                <li key={index}>
                                    <Link 
                                        to={item.href}
                                        className="block py-8 text-center hover:bg-slate-900 w-[100px] hover:text-white"
                                    >{item.label}</Link>
                                </li>
                            ))
                        }
                        ...
                        }
                        {
                            ...
                            <>
                                ...
                                <Link 
                                    className="bg-slate-600 py-3 px-10 text-md font-semibold text-white block text-center hover:bg-slate-900 hover:text-white rounded"
                                    to="/signup"
                                >Signup</Link>
                            </>
                        }
        ...
        {/* Childdrens end */}
           ...
           {/* Aside for phone for pc hidden Start */}
            <aside 
          ...
          {/* Aside for phone for pc hidden end*/}
