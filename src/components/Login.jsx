...
const Login = ()=>{
    ...
    return (
        ...
        <div className="grid md:grid-cols-2 md:h-screen md:overflow-hidden animate__animated animate__fadeIn">
            ...
            <div className="flex flex-col md:p-16 p-8  mt-11">
                ...
                <form className="mt-8 space-y-6" onSubmit={login}>
                    ...
                    </div>
                    {
                        ...
                        :
                        <button className="py-3 px-8 rounded bg-slate-600 text-white font-semibold hover:bg-slate-900">Login</button>
                    }
                </form>
                <div className="mt-2">
                ...
                {
                    error && 
                    <div className="flex justify-between items-center mt-2 bg-slate-600 p-3 rounded shadow text-white font-semibold animate__animated animate__pulse">
                        <p>{error}</p>
