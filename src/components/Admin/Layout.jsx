    ...
    return (
        <>
            ...
            <div className="md:block hidden">
                <aside 
                    className="bg-zinc-900 fixed top-0 left-0 h-full overflow-hidden"
                    style={{
                        width: size,
                        transition: '0.3s'
                    }}
                ...
                >
                    <nav className="bg-white p-6 shadow flex items-center justify-between sticky top-0 left-0">
                        <div className="flex gap-4 items-center">
                            ...
                            <h1 className="text-md font-semibold">Aftab<span className="text-blue-700 text-xl mx-2">Shop</span></h1>
                        </div>
