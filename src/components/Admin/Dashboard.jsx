        ...
        <Layout>
            <div className="grid md:grid-cols-4 gap-6">
                ...
                <div className="bg-lime-600 text-white rounded-lg shadow-lg py-8 px-4 border flex gap-6 items-center">
                    <div className="space-y-2">
                        <div className="flex justify-center items-center bg-lime-400 w-[64px] h-[64px] border-white  rounded-full shadow">
                ...
                <div className="bg-rose-600 text-white rounded-lg shadow-lg py-8 px-4 border flex gap-6 items-center">
                    <div className="space-y-2">
                        <div className="flex justify-center items-center bg-rose-400 w-[64px] h-[64px]  border-white  rounded-full shadow">
