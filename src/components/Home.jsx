...
import { getFirestore, addDoc, collection, getDocs, serverTimestamp, query, where, getDoc } from "firebase/firestore";
import "swiper/css";
...
const Home = ({slider, title="Latest Products"})=>{
  ...
  className="z-[-1] items-center mt-2"
>
